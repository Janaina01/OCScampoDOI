<?php /* Smarty version 2.6.26, created on 2021-10-07 19:16:50
...
<?php if ($this->_tpl_vars['currentSchedConf']->getSetting('metaDiscipline') || $this->_tpl_vars['currentSchedConf']->getSetting('metaSubjectClass') || $this->_tpl_vars['currentSchedConf']->getSetting('metaDOI') || $this->_tpl_vars['currentSchedConf']->getSetting('metaSubject') || $this->_tpl_vars['currentSchedConf']->getSetting('metaCoverage') || $this->_tpl_vars['currentSchedConf']->getSetting('metaType')): ?><p><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "author.submit.submissionIndexingDescription"), $this);?>
</p><?php endif; ?>
...
" size="40" maxlength="255" class="textField" />
	...
	<tr valign="top">
		<td class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'doi','key' => "paper.doi"), $this);?>
</td>
		<td class="value">
			<input type="text" name="doi[<?php echo ((is_array($_tmp=$this->_tpl_vars['formLocale'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
]" id="doi" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['doi'][$this->_tpl_vars['formLocale']])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
" size="40" maxlength="255" class="textField" />
			<?php if ($this->_tpl_vars['currentSchedConf']->getLocalizedSetting('metaDOIExamples') != ''): ?>
			<br />
			<span class="instruct"><?php echo ((is_array($_tmp=$this->_tpl_vars['currentSchedConf']->getLocalizedSetting('metaDOIExamples'))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</span>
			<?php endif; ?>
		</td>
	</tr>

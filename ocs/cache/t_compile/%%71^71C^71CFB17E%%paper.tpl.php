<?php /* Smarty version 2.6.26, created on 2021-10-14 04:25:28
         compiled from paper/paper.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'paper/paper.tpl', 15, false),array('function', 'url', 'paper/paper.tpl', 64, false),array('modifier', 'strip_unsafe_html', 'paper/paper.tpl', 25, false),array('modifier', 'escape', 'paper/paper.tpl', 26, false),array('modifier', 'date_format', 'paper/paper.tpl', 36, false),array('modifier', 'nl2br', 'paper/paper.tpl', 46, false),array('modifier', 'to_array', 'paper/paper.tpl', 85, false),array('modifier', 'assign', 'paper/paper.tpl', 96, false),)), $this); ?>
...
<br/>
	...
	<?php if ($this->_tpl_vars['paper']->getLocalizedDOI()): ?>
		<div id="paperDOI">
		<h4><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "paper.doi"), $this);?>
</h4>
		<br />
		<a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array(), $this);?>
"><?php echo ((is_array($_tmp=$this->_tpl_vars['paper']->getLocalizedDOI())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
</a>
		<br />
		<br />
		</div>

<?php /* Smarty version 2.6.26, created on 2021-10-07 19:19:17
         compiled from trackDirector/searchUsers.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'trackDirector/searchUsers.tpl', 17, false),array('function', 'html_options_translate', 'trackDirector/searchUsers.tpl', 19, false),array('function', 'translate', 'trackDirector/searchUsers.tpl', 22, false),array('function', 'page_info', 'trackDirector/searchUsers.tpl', 62, false),array('function', 'page_links', 'trackDirector/searchUsers.tpl', 63, false),array('modifier', 'escape', 'trackDirector/searchUsers.tpl', 26, false),array('block', 'iterate', 'trackDirector/searchUsers.tpl', 43, false),)), $this); ?>
...
<form name="submit" method="post" action="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'enrollSearch','path' => $this->_tpl_vars['paperId']), $this);?>
">
...
?><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'enrollSearch','path' => $this->_tpl_vars['paperId'],'searchInitial' => $this->_tpl_vars['letter']), $this);?>
...
<?php endif; ?></a> <?php endforeach; endif; unset($_from); ?><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'enrollSearch','path' => $this->_tpl_vars['paperId']), $this);?>
...
<div id="users">
<form action="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'enroll','path' => $this->_tpl_vars['paperId']), $this);?>
" method="post">
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['user']->getUsername())) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
	...
	<td><a href="<?php echo $this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'enroll','path' => $this->_tpl_vars['paperId'],'userId' => $this->_tpl_vars['user']->getId()), $this);?>

<?php /* Smarty version 2.6.26, created on 2021-10-14 04:36:38
...
" size="60" maxlength="255" class="textField" />
	...
	<table width="100%" class="data">
	<tr valign="top">
		<td width="5%" class="label"><input type="checkbox" name="metaDOI" id="metaDOI" value="1"<?php if ($this->_tpl_vars['metaDOI']): ?> checked="checked"<?php endif; ?> /></td>
		<td width="95%" class="value">
			<strong><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'metaDOI','key' => "manager.schedConfSetup.submissions.doi"), $this);?>
</strong>
			<br />
			<span class="instruct"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "manager.schedConfSetup.submissions.doiDescription"), $this);?>
</span>
		</td>
	</tr>
	<tr>

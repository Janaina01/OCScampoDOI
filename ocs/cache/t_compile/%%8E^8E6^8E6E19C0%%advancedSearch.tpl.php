<?php /* Smarty version 2.6.26, created on 2021-10-13 20:29:44
         compiled from search/advancedSearch.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'search/advancedSearch.tpl', 33, false),array('function', 'url', 'search/advancedSearch.tpl', 51, false),array('function', 'html_options', 'search/advancedSearch.tpl', 61, false),array('function', 'html_select_date', 'search/advancedSearch.tpl', 90, false),array('modifier', 'escape', 'search/advancedSearch.tpl', 33, false),)), $this); ?>
...
function ensureKeyword() {
	...
	if (allBlank) {allBlank = document.search.doi.value == \'\';}
...
<tr valign="top">
	<td class="label"><label for="doi"><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "search.doi"), $this);?>
</label></td>
	<td class="value"><input type="text" name="doi" id="doi" size="40" maxlength="255" value="<?php echo ((is_array($_tmp=$this->_tpl_vars['doi'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
" class="textField" /></td>
</tr>
<tr valign="top">

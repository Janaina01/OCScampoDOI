<?php /* Smarty version 2.6.26, created on 2021-10-07 19:13:36
...
<tr valign="top">
<td<?php if ($this->_tpl_vars['currentSchedConf']->getLocalizedSetting('metaDOIExamples') != ''): ?> rowspan="2"<?php endif; ?> width="20%" class="label"><?php echo $this->_plugins['function']['fieldLabel'][0][0]->smartyFieldLabel(array('name' => 'doi','key' => "paper.doi"), $this);?>
</td>
	<td width="80%" class="value"><input type="text" class="textField" name="doi[<?php echo ((is_array($_tmp=$this->_tpl_vars['formLocale'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>

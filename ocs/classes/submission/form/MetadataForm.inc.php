...
class MetadataForm extends Form {
	...
	function initData() {
		if (isset($this->paper)) {
			...
			$this->_data = array(
				...
				'doi' => $paper->getDOI(null), // Localized
	...
	function getLocaleFieldNames() {
		return array('title', 'abstract', 'subjectClass', 'subject', 'doi', 'coverageGeo', 'coverageChron', 'coverageSample', 'type', 'sponsor', 'citations');
	}
	...
	function execute() {
		...
		$paper->setDOI($this->getData('doi'), null); // Localized

...
class Submission extends DataObject {
	...
	/**
	 * Return the localized DOI
	 * @return string
	 */
	function getLocalizedDOI() {
		return $this->getLocalizedData('doi');
	}
	 ...
	 * @return string
	 */
	function getDOI($locale) {
		return $this->getData('doi', $locale);
	}
	 ...
	 * @param $locale
	 */
	function setDOI($doi, $locale) {
		return $this->setData('doi', $doi, $locale);
	}

...
<tr valign="top">
<td{if $currentSchedConf->getLocalizedSetting('metaDOIExamples') != ''} rowspan="2"{/if} width="20%" class="label">{fieldLabel name="doi" key="paper.doi"}</td>
	<td width="80%" class="value"><input type="text" class="textField" name="doi[{$formLocale|escape}]" id="doi" value="{$doi[$formLocale]|escape}" size="40" maxlength="255" /></td>
</tr>
<tr valign="top">
	<td>&nbsp;</td>
	<td>&nbsp;</td>

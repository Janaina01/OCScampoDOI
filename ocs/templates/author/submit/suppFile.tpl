...
<tr valign="top">
	<td width="20%" class="label">{fieldLabel name="doi" key="common.keywords"}</td>
	<td width="80%" class="value"><input type="text" name="doi[{$formLocale|escape}]" class="textField" id="doi" value="{$doi[$formLocale]|escape}" size="60" maxlength="255" /></td>
</tr>
<tr valign="top">

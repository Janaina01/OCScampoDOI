...
<table width="100%" class="data">
	...
	<table width="100%" class="data">
	<tr valign="top">
		<td width="5%" class="label"><input type="checkbox" name="metaDOI" id="metaDOI" value="1"{if $metaDOI} checked="checked"{/if} /></td>
		<td width="95%" class="value">
			<strong>{fieldLabel name="metaDOI" key="manager.schedConfSetup.submissions.doi"}</strong>
			<br />
			<span class="instruct">{translate key="manager.schedConfSetup.submissions.doiDescription"}</span>
		</td>
	</tr>
	<tr>
	<tr>

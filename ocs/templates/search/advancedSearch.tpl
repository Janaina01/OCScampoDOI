...
<tr valign="top">
	<td class="label"><label for="doi">{translate key="search.doi"}</label></td>
	<td class="value"><input type="text" name="doi" id="doi" size="40" maxlength="255" value="{$doi|escape}" class="textField" /></td>
</tr>
<tr valign="top">

...
<table width="100%" class="data">
	...
	<tr valign="top">
		<td class="label">{fieldLabel name="doi" key="common.doi"}</td>
		<td class="value"><input type="text" name="doi[{$formLocale|escape}]" id="doi" value="{$doi[$formLocale]|escape}" size="60" maxlength="255" class="textField" /></td>
	</tr>
	<tr valign="top">
